...
export async function apiCall<T>(endpoint: string, options: RequestInit = {}): Promise<T> {
  ...
  // - All platforms: use stored session token as Bearer auth
  // - Web: token is stored in localStorage and sent as Authorization header
  // - Native: token is stored in SecureStore and sent as Authorization header
